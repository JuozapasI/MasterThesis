...
\begin{enumerate}
  ...
  Although potentially informative, reads from such unannotated regions are typically ignored in a standard scRNA-seq analysis.
  \item Complexity and overlaps in transcriptomic features – the genomes of humans are highly complex,
   ...
   Reads from such overlapping regions are usually discarded from downstream analysis,
   due to the inability to assign unique gene per read.
\end{enumerate}
