...
Three aspects were considered while enhancing trnascriptomic reference:
\begin{itemize}
  \item \textbf{Gene overlaps} – some of genes are overlapping, resulting in unassigned reads from those overlapping regions.
  ...
  there are small fraction of genes that are present in some references but not in others.
  Hence, for the enhancing trnascriptomic reference, several transcriptomic references were used.
\end{itemize}
...
Particularly, genes types was devided into three groups: protein coding, long non-coding RNAs and other,
...
if they overlapped with unassigned reads and did not overlapped with genes already present in the reference.
