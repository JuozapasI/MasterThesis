...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Resolve overlapping genes that also overlap with unassigned reads (if possible).
            \item From the second reference and further: add genes to the original transcriptomic reference
            that i) overlap with unassigned reads and
            ii) do not overlap with entries from the original transcriptomic reference.
        \end{enumerate}
        \item For intergenic:
        \begin{enumerate}
            \item Cluster.
            ...
            \item For the last reference only: clusters that start just after 3' ends of known genes are assigned
            to those genes (by extending genes in transcriptomic reference).
        \end{enumerate}
    \end{enumerate}
...
Intersections were assesed in a strand-specific manner (bedtools '-s' flag), i.e. regions on different strands were treated as not intersecting,
