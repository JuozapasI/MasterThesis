...
To identify such regions, those with conservation scores above 0.6 was defined as conserved (there were 5 of such isolated regions).
...
\begin{figure}
  ...
  However, the amount of reads gained is tinywhen compared with total count of this gene
