...
Such enhanced reference allowed to have on average 1.2\% more reads in the cell-gene matrices.
While this amount is not big, it allowed to capture approximatelly 350 genes, that were undetected using standard transcriptomic reference.
However, approximatelly 13 genes were lost for each dataset using this enhanced transcriptomic reference.
Even though the amount of data increased, it is not straightforward that data quality increased,
since overlap handling rules can be debatable, whether they should be applicable in all cases.
