#!/bin/bash
#SBATCH -J solo_J
#SBATCH -o /tmp/Mazutislab-out/Juozapas/Thesis/data/PBMC_10x/solo_output_full_reference_RE/slurm.log
...
STAR \
    --genomeDir /tmp/Mazutislab-out/Juozapas/Thesis/data/PBMC_10x/index_full_RE/ \
    ...
    --runThreadN 14 \
    --outFileNamePrefix /tmp/Mazutislab-out/Juozapas/Thesis/data/PBMC_10x/solo_output_full_reference_RE/ \
