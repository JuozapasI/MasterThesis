#!/bin/bash
#SBATCH -J solo_J
#SBATCH -o /tmp/Mazutislab-out/Juozapas/Thesis/data/datasets/PBMC_10x_2/solo_output.10x/slurm.log
...
fastq_dir="/tmp/Mazutislab-out/Juozapas/Thesis/data/datasets/PBMC_10x_2/10k_PBMC_3p_nextgem_Chromium_X_fastqs/"
...
for lane in {1..4}; do
    ...
    read1_files+="${fastq_dir}10k_PBMC_3p_nextgem_Chromium_X_S1_L00${lane}_R1_001.fastq.gz,"
    # Concatenate read 2 files
    read2_files+="${fastq_dir}10k_PBMC_3p_nextgem_Chromium_X_S1_L00${lane}_R2_001.fastq.gz,"
done
...
STAR \
    ...
    --runThreadN 14 \
    --outFileNamePrefix /tmp/Mazutislab-out/Juozapas/Thesis/data/datasets/PBMC_10x_2/solo_output.10x/ \
