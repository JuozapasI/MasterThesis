...
unassigned_bam_gencode=$7
intersecting_bam_gencode=$8
intergenic_bam_gencode=$9

unassigned_bam_ncbi=${10}
intersecting_bam_ncbi=${11}
intergenic_bam_ncbi=${12}

unassigned_bam_lnc=${13}
intersecting_bam_lnc=${14}
intergenic_bam_lnc=${15}
...
intergenic_good_lnc=$(awk -F'\t' -v t="$threshold" '$5 > t {sum += $5} END {print sum}' $intergenic_good_bed)
