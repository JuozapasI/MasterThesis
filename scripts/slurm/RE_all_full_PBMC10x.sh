...
Rscript /tmp/Mazutislab-out/Juozapas/Thesis/scripts/RefEnh/main1.R \
  ...
  /tmp/Mazutislab-out/Juozapas/Thesis/data/PBMC_10x/solo_output_full/Aligned.sortedByCoord.out.bam \
  /tmp/Mazutislab-out/Juozapas/Thesis/data/PBMC_10x/solo_output_full/Aligned.sortedByCoord.out.bam.bai \
